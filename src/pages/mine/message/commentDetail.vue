...
export default {
  ...
  methods: {
    ...
    toActivity() {
       if (this.act_type == 1) {
          wx.navigateTo({
            url: "/pages/activity/detail/detail?act_id=" + this.act_id
          });
        } else if (this.act_type == 2) {
          wx.navigateTo({
            url: `/packageA/activity/recruitmentActivities/recruitmentDetails?act_id=${this.act_id}`
          });
        } else if (this.act_type == 3) {
          wx.navigateTo({
            url: `/packageA/activity/academicEvents/academicDetails?act_id=${this.act_id}`
          });
        } else if (this.act_type == 4) {
          wx.navigateTo({
            url: `/packageA/activity/competitionActivity/competitionDetails?act_id=${this.act_id}`
          });
